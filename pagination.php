...
if ( empty($solida_option ['blog-pagination']) ){
				...
				if($next_post):?>	
				  <li class="prev">
				    <a href="<?php echo esc_url( $url_next ) ?>">
				    	<span class="next_link"><i class="flaticon-back-1"></i><?php echo esc_html__('Previous', 'solida'); ?></span>
				...
				<?php endif;     
				  ...
				  <li class="next">
				    <a href="<?php echo esc_url( $url_previous ) ?>">
				    	<span class="next_link"><?php echo esc_html__('Next', 'solida'); ?><i class="flaticon-next"></i></span>
				    	<span class="link_text"><?php echo esc_attr( $title ); ?> </span>
					</a>
				  </li>
			  <?php endif; ?>
