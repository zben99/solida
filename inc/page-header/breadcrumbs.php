...
<?php 
  ...
  if($post_meta_data == ''){
    if(!empty($solida_option['page_banner_main']['url'])):
      $post_meta_data = $solida_option['page_banner_main']['url'];
    endif;
  }  
...
if(!empty($solida_option['off_breadcrumb_area'])){  
?>
...
<div class="tentaz-breadcrumbs  porfolio-details">
  <div class="tentaz-breadcrumbs-inner bread-<?php echo esc_attr($post_menu_type); ?>">
    <div class="<?php echo esc_attr($header_width);?>">
      <div class="row">
        <div class="col-md-12 text-center">
