...
<?php 
    $post_menu_type = get_post_meta($solida_shop_id, 'menu-type', true); 
    $post_meta_data = get_post_meta($solida_shop_id, 'banner_image', true);
    $content_banner = get_post_meta($solida_shop_id, 'content_banner', true); 
    $banner_hide = get_post_meta($solida_shop_id, 'banner_hide', true); 
              ...
              <div class="row">
                <div class="col-md-12 text-center">
                  <div class="breadcrumbs-inner bread-<?php echo esc_attr($post_menu_type); ?>"> 
                    <?php 
                        $post_meta_title = get_post_meta($solida_shop_id, 'select-title', true);?>
                        ...
                        if(!empty($solida_option['off_breadcrumb'])){
                            $tentaz_breadcrumbs = get_post_meta($solida_shop_id, 'select-bread', true);
                    ...
                    <div class="col-md-12 text-center">
                      <div class="breadcrumbs-inner bread-<?php echo esc_attr($post_menu_type); ?>">            
                        <h1 class="page-title"><?php woocommerce_page_title();?></h1>
                         <?php if(!empty($solida_option['off_breadcrumb'])){                 
