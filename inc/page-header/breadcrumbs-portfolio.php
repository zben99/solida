...
<?php if($banner_hide !='hide'){
    ...
    if(!empty($solida_option['disable_portfoli_banner'])): ?>
                  ...
                  <div class="breadcrumbs-inner bread-<?php echo esc_attr($post_menu_type); ?>"> 
                    <?php 
                        ...
                        if(!empty($solida_option['off_breadcrumb'])){
                            $tentaz_breadcrumbs = get_post_meta(get_the_ID(), 'select-bread', true);
    ...
    <?php }
    elseif (!empty($solida_option['department_single_image']['url'])) {
        ?>
        <div class="breadcrumbs-single" style="background-image: url('<?php echo esc_url( $solida_option['department_single_image']['url'] );?>')">
            <div class="<?php echo esc_attr($header_width);?>">
              <div class="row">
                <div class="col-md-12 text-center">
                  <div class="breadcrumbs-inner bread-<?php echo esc_attr($post_menu_type); ?>"> 
